...
(function () {
  ...
  CKEDITOR.event || (CKEDITOR.event = function () {
    ...
    return {
      define: function (b, d) {
        ...
        function p(a, x, w, e) {
          a = {name: b, sender: this, editor: a, data: x, listenerData: k, stop: w, cancel: e, removeListener: q};
  ...
  (function () {
    ...
    CKEDITOR.tools = {
      ...
      transformPlainTextToHtml: function (a, b) {
        ...
        if (!e) {
          var m = /\n{2}/g;
          if (m.test(c)) var d = "\x3c" + h + "\x3e", p = "\x3c/" + h + "\x3e", c = d + c.replace(m, function () {
            return p + d
          }) + p
        }
        c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      is: function () {
        ...
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
          ...
          var f = this.$.getBoundingClientRect(), g = e.$.documentElement, v = g.clientTop || d.$.clientTop || 0,
            m = g.clientLeft || d.$.clientLeft || 0, k = !0;
  ...
  (function () {
    ...
    var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(),
      h = CKEDITOR.dom.walker.temp(), p = function (a) {
  ...
  (function () {
      ...
      trim: function (a, b) {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var I, P, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
              l = null, K = function (a) {
        ...
        if (!this.collapsed) {
          ...
          var g = new CKEDITOR.dom.walker(g), r = CKEDITOR.dom.walker.bookmark(), C = CKEDITOR.dom.walker.bogus();
    ...
    CKEDITOR.dom.range.mergeRanges = function (a) {
      return CKEDITOR.tools.array.reduce(a, function (a, b) {
        ...
        if (c) {
          var e = new CKEDITOR.dom.range(b.root), d = new CKEDITOR.dom.walker(e), f = CKEDITOR.dom.walker.whitespaces();
    ...
    CKEDITOR.htmlParser.fragment.fromHtml =
      function (g, k, h) {
        ...
        F.onText = function (a) {
          ...
          var b = u.name, e = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
  ...
  (function () {
    ...
    var u = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", n = CKEDITOR.dtd,
      r = "caption colgroup col thead tfoot tbody".split(" "), C = CKEDITOR.tools.extend({}, n.$blockLimit, n.$block),
      L = {elements: {input: h, textarea: h}}, D = {
    ...
    var E = /<(a|area|img|input|source)\b([^>]*)>/gi, y = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      I = /^(href|src|name)$/i, P = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
  ...
  (function () {
    ...
    function b(a) {
      var b = a.name, d = a.element, k = a.elementMode, h =
          a.fire("uiSpace", {space: "top", html: ""}).html, p = a.fire("uiSpace", {space: "bottom", html: ""}).html,
  ...
  (function () {
    ...
    v = function () {
      ...
      var E = CKEDITOR.dtd,
        y = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1},
        I = {
          p: 1, div: 1, h1: 1, h2: 1,
          h3: 1, h4: 1, h5: 1, h6: 1
      ...
      eol: {
        ...
        rebuild: function (a, b) {
          var c = a.range, d = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(d, b),
            f = new CKEDITOR.dom.elementPath(c.startContainer, b), c = new CKEDITOR.dom.elementPath(c.endContainer, b),
            t;
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), g = e.contains(CKEDITOR.dtd.$list),
          ...
          detectMerge: function (a,
            ...
            if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
              var d = a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode,
                f = new CKEDITOR.dom.elementPath(d, c), g = new CKEDITOR.dom.elementPath(e, c), f = f.block,
                g = g.block;
          ...
          function a(c) {
            var e =
              [], f, g = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d), h = c.endPath().contains(d), l = {};
  ...
  (function () {
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      c.on("contentDom", function () {
        ...
        var e = c.document, f = CKEDITOR.document, h = c.editable(), t = e.getBody(), n = e.getDocumentElement(),
          E = h.isInline(), q, p;
...
*/
    ...
    onLoad: function () {
            ...
            CKEDITOR.ui.dialog.labeledElement.call(this,
              b, a, d, function () {
                for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
                  var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0], n = void 0 !== l[1] ? l[1] : l[0],
      ...
      CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
        getInputElement: function () {
          ...
          var a = this._, d = CKEDITOR.document.getById(a.frameId).getFrameDocument(), f = a.definition, c = a.buttons,
            e = this.formLoadedNumber, m = this.formUnloadNumber, g = a.dialog._.editor.lang.dir,
    ...
    r.prototype = {
      add: function (b) {
        ...
        var a = this.element, c = this.editor, d = c.ui.contentsElement.getClientRect(),
          e = c.ui.contentsElement.getDocumentPosition(), f, l, u = a.getClientRect(), m, g = this._notificationWidth,
  ...
  (function () {
    ...
    CKEDITOR.ui.button.prototype = {
      render: function (a, b) {
        ...
        var p = null, q = CKEDITOR.env, r = this._.id = CKEDITOR.tools.getNextId(), g = "", d = this.command, k, l, m;
        this._.editor = a;
        var e = {
            ...
            if (a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
              ...
              a.addCommand("toolbarCollapse", {
                readOnly: 1, exec: function (b) {
                  var a = b.ui.space("toolbar_collapser"), c = a.getPrevious(), d = b.ui.space("contents"),
                    e = c.getParent(), h = parseInt(d.$.style.height, 10), g = e.$.offsetHeight,
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("clipboard", {
      requires: "dialog,notification,toolbar", init: function (a) {
        ...
        a.on("paste", function (b) {
          b = b.data;
          var d = a._.nextPasteType || b.type, f = b.dataValue, g, m = a.config.clipboard_defaultContentType || "html",
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      getRangeAtDropPosition: function (a, b) {
        var c = a.data.$, d = c.clientX, g = c.clientY, h = b.getSelection(!0).getRanges()[0], e = b.createRange();
        if (a.data.testRange) return a.data.testRange;
        if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, g)) c = b.document.$.caretRangeFromPoint(d, g), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), e.collapse(!0); else if (c.rangeParent) e.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), e.collapse(!0);
        else {
            ...
            try {
              ...
              if (f) {
                ...
                var q = b.document.$.elementFromPoint(d,
                  g), p = new CKEDITOR.dom.element(q), r;
          ...
          createPanel: function (c) {
            ...
            if (!a.panel) {
              var f = this._.panelDefinition, e = this._.panelDefinition.block,
                g = f.parent || CKEDITOR.document.getBody(), d = this._.panel = new CKEDITOR.ui.floatPanel(c, g, f),
                f = d.addBlock(a.id, e), b = this;
              d.onShow = function () {
      ...
      $: function (a, b, c, m) {
        ...
        addBlock: function (a, b) {
          ...
          var l = this.element, e = this._.iframe,
            ...
            f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir, d = t.x + (m || 0) - f.x,
            p = t.y + (h || 0) - f.y;
          ...
          CKEDITOR.tools.setTimeout(function () {
            var a = CKEDITOR.tools.bind(function () {
              ...
              var b = n.element.getWindow(), a = l.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                c = a.width || a.right - a.left, e = a.height || a.bottom - a.top, m = q ? a.right : b.width - a.left,
  ...
  CKEDITOR.plugins.add("colorbutton", {
    requires: "panelbutton,floatpanel", init: function (e) {
      function t(a, d, g, r, k) {
        var p = new CKEDITOR.style(l["colorButton_" + d + "Style"]), m = CKEDITOR.tools.getNextId() + "_colorBox", q;
        k = k || {};
    ...
    CKEDITOR.menuItem = CKEDITOR.tools.createClass({
      $: function (a, b, d) {
        ...
        render: function (a, b, d) {
          var h = a.id + String(b), g = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, k = "",
            e = this.editor, f, c,
          ...
          addTarget: function (a, f) {
            ...
            a.on("contextmenu", function (a) {
              ...
              if (!f || !b) if (a.preventDefault(),
                ...
                var c = a.getTarget().getDocument(), g = a.getTarget().getDocument().getDocumentElement(),
  ...
  (function () {
    ...
    CKEDITOR.plugins.copyformatting = {
      ...
      commands: {
        copyFormatting: {
          exec: function (a, b) {
            var e = CKEDITOR.plugins.copyformatting, d = a.copyFormatting, c = b ? "keystrokeHandler" == b.from : !1,
              f = b ? b.sticky || c : !1, g = e._getCursorContainer(a), h = CKEDITOR.document.getDocumentElement();
      ...
      _getSelectedWordOffset: function (a) {
        ...
        function d(a,
          ...
          if (m) c ?
            n = 0 : (g = /([\.\b]*$)/, n = (k = g.exec(h)) ? k.index : h.length); else if (c && (n += 1, n > h.length)) return d(f);
      ...
      _applyFormat: function (a, b) {
        var e = a.getSelection().getRanges()[0], d = CKEDITOR.plugins.copyformatting, c, f;
        if (!e) return !1;
        if (e.collapsed) {
          f =
    ...
    CKEDITOR.plugins.enterkey =
      {
        enterBlock: function (a, e, b, l) {
          ...
          if (b = b || y(a)) {
            b = z(b);
            var g = b.document, f = b.checkStartOfBlock(), k = b.checkEndOfBlock(), p = a.elementPath(b.startContainer),
              c = p.block, m = e == CKEDITOR.ENTER_DIV ? "div" : "p", d;
            if (c && f && k) {
              f = c.getParent();
    ...
    function l(a, b, d, c) {
      if (c &&
        ...
        e.onClick = function (b) {
          var c = b.sender, d = c.getDialog().getContentElement(this["for"][0], this["for"][1]).getInputElement(),
  ...
  CKEDITOR.plugins.add("forms", {
    requires: "dialog,fakeobjects", onLoad: function () {
      ...
      (d.form = {label: a.forms.form.menu, command: "form", group: "form"}), b.addMenuItems(d));
      ...
      b.on("doubleclick", function (a) {
        ...
        if (!b.blockless && c.is("form")) a.data.dialog = "form"; else if (c.is("select")) a.data.dialog = "select"; else if (c.is("textarea")) a.data.dialog =
          "textarea"; else if (c.is("img") && "hiddenfield" == c.data("cke-real-element-type")) a.data.dialog = "hiddenfield"; else if (c.is("input")) {
        ...
        function g(f) {
          ...
          this.jobs[this.isIndent ? 10 : 30] = {
            refresh: this.isIndent ? function (f, c) {
              var g = this.getContext(c), b = CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, g);
  ...
  (function () {
    CKEDITOR.plugins.add("language", {
      requires: "menubutton", init: function (a) {
        var b = a.config.language_list || ["ar:Arabic:rtl", "fr:French", "es:Spanish"], c = this, d = a.lang.language,
          e = {}, g, h, k, f;
        ...
        }, e[k].style = new CKEDITOR.style({element: "span", attributes: {lang: h, dir: e[k].ltr ? "ltr" : "rtl"}});
        e.language_remove = {
          label: d.remove,
        ...
        switch (b.type) {
          ...
          case "email":
            ...
            switch (a) {
              case "":
              case "encode":
                var g = encodeURIComponent(e.subject || ""), k = encodeURIComponent(e.body || ""), e = [];
  ...
  (function () {
    ...
    function N(a, l, d) {
      ...
      var k = CKEDITOR.plugins.list.arrayToList(e, d, null, a.config.enterMode, l.root.getAttribute("dir")).listNode, c,
        p;
      f(!0);
      f();
      k.replace(l.root);
      ...
      listToArray: function (a, l, d, f, e) {
        ...
        for (var g, b = a[d].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(b), k = null, c = d, p = Math.max(a[d].indent, 0), m =
          ...
          CKEDITOR.env.needsNbspFiller && 7 >= b.$.documentMode && m.append(b.createText(" ")), m.append(c.listNode), c = c.nextIndex; else if (-1 == q.indent && !d && g) {
            ...
            var k = g.getDirection(1) != n, w = q.element, B = w.getAttribute("class"), E = w.getAttribute("style"),
  ...
  (function () {
    ...
    function la(a) {
      ...
      v(d, {
        ...
        place: function () {
          var b = a.view, c = a.editable, d = a.trigger, h = d.upper, g = d.lower, l = h || g, p = l.getParent(),
            m = {};
          this.trigger = d;
          h && r(a, h, !0);
          g && r(a, g, !0);
    ...
    var v = CKEDITOR.tools.extend, R = CKEDITOR.dom.element, G = R.createFromHtml, t = CKEDITOR.env,
      ja = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, B = CKEDITOR.dtd, K = {}, I = 128, da = 64, T = 32, M = 16,
      C = 4, D = 2, x = 1, J = " ", fa = B.$listItem, oa = B.$tableContent, ma = v({}, B.$nonEditable, B.$empty),
      Z = B.$block, ga = 100,
      ...
      removeformat: {
        exec: function (a) {
          for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), d = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, p = a.getSelection().getRanges().createIterator(), q = function (a) {
            ...
            var e = c.createBookmark(), b = e.startNode, l = e.endNode, m = function (b) {
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("showblocks", {
      onLoad: function () {
        var a = "p div pre address blockquote h1 h2 h3 h4 h5 h6".split(" "), c, b, e, f, k = CKEDITOR.getUrl(this.path),
          l = !(CKEDITOR.env.ie &&
    ...
    parseConfig: function (a) {
      ...
      return {
        scayt: {
          ...
          grayt_ignoreall: {
            label: a.getLocal("btn_ignoreAll"), group: "grayt_control", order: 3, exec: function (a) {
  ...
  CKEDITOR.plugins.add("table", {
    requires: "dialog", init: function (a) {
      ...
      if (!a.blockless) {
        ...
        a.addMenuItems && a.addMenuItems({
          table: {label: e.menu, command: "tableProperties", group: "table", order: 5},
  ...
  (function () {
    function q(d, f) {
      ...
      for (var a = d.getRanges(), k = 0; k < a.length; k++) {
        var h = a[k];
        if (h.collapsed) (h = h.getCommonAncestor().getAscendant({td: 1, th: 1}, !0)) && b(h) && e.push(h); else {
    ...
    function B(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        var f = d.getRanges(), b = q(d), c = b[0].getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c),
          ...
          b = b[b.length - 1], a = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = [];
        d.reset();
        for (d = g; d <= a; d++) {
    ...
    function y(d) {
      ...
      var b = d.getRanges(), c = q(d), e = c[0], g = c[c.length - 1], c = e.getAscendant("table"),
        a = CKEDITOR.tools.buildTableMap(c), k, h, l = [];
      d.reset();
      var m = 0;
      for (d = a.length; m < d; m++) for (var n =
        0, p = a[m].length; n < p; n++) void 0 === k && a[m][n] == e.$ && (k = n), a[m][n] == g.$ && (h = n);
      for (m = k; m <= h; m++) for (n = 0; n < a.length; n++) g = a[n], e = new CKEDITOR.dom.element(c.$.rows[n]), g = new CKEDITOR.dom.element(g[m]), g.$ && (1 == g.$.colSpan ? g.remove() : --g.$.colSpan, n += g.$.rowSpan - 1, e.$.cells.length || l.push(e));
    ...
    function z(d) {
      if (d instanceof CKEDITOR.dom.selection) {
        ...
        a:{
          ...
          for (g = 0; k = b[g++];) if ((h = k.getPrevious()) && !h.getCustomData("delete_cell") || (h = k.getNext()) && !h.getCustomData("delete_cell")) {
    ...
    function x(d, f, b) {
      ...
      var a = CKEDITOR.tools.buildTableMap(e), k = a.length, h = a[0].length, l = d.getParent().$.rowIndex,
        m = A(a, l, d);
      if (f) {
        var n;
        try {
      ...
      for (f = 0; f < c.length; f++) {
        g = c[f];
        var t = g.getParent(),
          y = g.getFirst(), v = g.$.colSpan, z = g.$.rowSpan, t = t.$.rowIndex, B = A(a, t, g), w = w + v * z,
          p = Math.max(p, B - m + v);
        n = Math.max(n, t - l + z);
        b || (v = g, (z = v.getBogus()) && z.remove(), v.trim(), g.getChildren().count() && (t == r || !y || y.isBlockBoundary && y.isBlockBoundary({br: 1}) || (r = u.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !r || r.is && r.is("br") || u.append("br")), g.moveChildren(u)), f ? g.remove() : g.setHtml(""));
        r = t
      }
      if (b) return n * p == w;
      u.moveChildren(d);
    ...
    function C(d, f) {
      ...
      if (f) return !0;
      var b = b[0], c = b.getParent(), e = c.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(e),
        a = c.$.rowIndex, k = A(g, a, b), h = b.$.rowSpan, l;
      if (1 < h) {
        l = Math.ceil(h / 2);
        for (var h = Math.floor(h / 2), c = a + l, e = new CKEDITOR.dom.element(e.$.rows[c]), g = A(g, c), m, c = b.clone(), a = 0; a < g.length; a++) if (m = g[a], m.parentNode == e.$ &&
        a > k) {
          c.insertBefore(new CKEDITOR.dom.element(m));
          break
        } else m = null;
        m || e.append(c)
      } else for (h = l = 1, e = c.clone(), e.insertAfter(c), e.append(c = b.clone()), m = A(g, a), k = 0; k < m.length; k++) m[k].rowSpan++;
      c.appendBogus();
      b.$.rowSpan = l;
      c.$.rowSpan = h;
    ...
    function E(d, f) {
      ...
      var b = b[0], c = b.getParent(), e = c.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(e),
        g = A(e, c.$.rowIndex, b), a = b.$.colSpan;
    ...
    CKEDITOR.plugins.tabletools = {
      requires: "table,dialog,contextmenu", init: function (d) {
        ...
        b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", f({
          ...
          requiredContent: g, contentTransformations: [[{
  ...
  (function () {
    ...
    function w(a) {
      ...
      if (a.data.getTarget().getName && ("mouseup" === a.name || !D(a.data.getTarget()))) {
        var e = a.editor || a.listenerData.editor, g = e.getSelection(1), h = J(e), k = a.data.getTarget(),
    ...
    var H = {
      onPaste: function (a) {
        ...
        var d = a.editor, e = d.getSelection(), g = v(e), h = this.findTableInPastedContent(d,
          a.data.dataValue), k = e.isInTable(!0) && this.isBoundarySelection(e), f, l;
        ...
        for (l = 0; l < c.length; l++) for (k = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++) if (f = new CKEDITOR.dom.element(c[l][p]), d = b[l] &&
        b[l][p] ? new CKEDITOR.dom.element(b[l][p]) : null, f && !f.getCustomData("processed")) {
          if (d && d.getParent()) f.replace(d); else if (0 === p || c[l][p - 1]) (d = 0 !== p ? new CKEDITOR.dom.element(c[l][p - 1]) : null) && k.equals(d.getParent()) ? f.insertAfter(d) : 0 < e ? k.$.cells[e] ? f.insertAfter(new CKEDITOR.dom.element(k.$.cells[e])) : k.append(f) : k.append(f, !0);
    ...
    CKEDITOR.plugins.tableselection =
      {
        getCellsBetween: z, keyboardIntegration: function (a) {
          ...
          c.attachListener(c, "keydown", function (a) {
            ...
            delete h.th;
            return function (k) {
              var f = k.data.getKey(), l = k.data.getKeystroke(), h, m = 37 === f || 38 == f, n, q, r;
  ...
  (function () {
        ...
        exec: function (a, d) {
          ...
          if (f && f.name == b.name) f.edit(); else if (b.insert) b.insert({
            ...
            var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
              f = CKEDITOR.dom.element.createFromHtml(b.template.output(f)), h, l = a.widgets.wrapElement(f, b.name),
    ...
    function B(a, b) {
      ...
      if (!d.getById("cke_copybin")) {
        var f = !c.blockless && !CKEDITOR.env.ie || e ? "div" : "span", e = d.createElement(f), h = d.createElement(f),
        ...
        h.append(e);
        c.editable().append(h);
        var k = c.on("selectionChange", F, null, null, 0), m = a.repository.on("checkSelection", F, null, null, 0);
    ...
    function ba(a) {
      ...
      if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
        var c = this.repository.finder,
          d = this.repository.locator, e = this.repository.liner, f = this.editor, h = f.editable(), g = [], k = [], m,
          n;
    ...
    g.prototype = {
      ...
      initEditable: function (a, b) {
        ...
        return c && c.is(CKEDITOR.dtd.$editable) ? (c = new q(this.editor, c, {filter: x.call(this.repository, this.name, a, b)}), this.editables[a] = c, c.setAttributes({
    ...
    CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      addUploadWidget: function (a, c, f) {
        ...
        CKEDITOR.tools.extend(f, {
          ...
          init: function () {
            var d = this, c = this.wrapper.findOne("[data-cke-upload-id]").data("cke-upload-id"), k = b.loaders[c],
              f = CKEDITOR.tools.capitalize, g, e;
        ...
        if (CKEDITOR.plugins.clipboard.isFileApiSupported) {
          ...
          e && (a.addUploadWidget(c, "uploadimage", {
            ...
            if (b.data.dataValue.match(/<img[\s\S]+data:/i)) {
              b = b.data;
              var f = document.implementation.createHTMLDocument(""), f = new CKEDITOR.dom.element(f.body), m, g, k;
