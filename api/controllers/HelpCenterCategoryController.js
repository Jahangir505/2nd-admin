...
module.exports = {
    _config: {
      ...
      index: function (req, res) {
        ...
        // =============Embaded Start===============
        return Promise.all([
          HelpCenterCategory.count(qdata),
          HelpCenterCategory.find(qdata).paginate({page: currentPage, limit: pageLimit}).sort('id ' +paSortBy),
        ])
          .spread(function(totalCount, allRecord){
            ...
            return res.view("admin/help-center-category/index", {
                ...
                title: 'Category',
                subtitle: 'Index',
                link1: '/admin/help-center-category/index/',
                // linkback1: '/admin/BBACKK/index/',
                linknew: '/admin/help-center-category/new/',
        
                paginateUrl: '/admin/help-center-category/index',
            ...
            return res.redirect('/admin/help-center-category/index');
          });
        // =============Embaded End=================
      ...
      new : function (req, res) {
        ...
        return res.view("admin/help-center-category/new", {
            flashMsgError: req.flash('flashMsgError'),
            flashMsgSuccess: req.flash('flashMsgSuccess'),
            data: _formData,
            formActionTarget : "/admin/help-center-category/create",
            status: 'OK',
            // fieldErrors: {},
            customFieldErrors: {},
            module: 'Help Center',
    ...
    return Promise.all([
        HelpCenterCategory.findOne({name: _formData.name}),
      ...
      //  console.log('main_image_Ret is', main_image_Ret);
        ...
        if (Object.keys(customFieldErrors).length) {
          ...
          return HelpCenterCategory.create(_formData).then(function (createData) {
        ...
        return res.redirect('/admin/help-center-category/new');
      });
    // =============Promisses End=======================
      },
      ...
      edit: function (req, res) {
        ...
        HelpCenterCategory.findOne({id:id}).then(function (singledata){
          if (!singledata) {
            req.flash('flashMsgError', 'Data Not Found In Database');
            return res.redirect('/admin/help-center-category/index');
          }else{
            return res.view("admin/help-center-category/edit", {
              flashMsgError: req.flash('flashMsgError'),
              flashMsgSuccess: req.flash('flashMsgSuccess'),
              data: singledata,
              formActionTarget : "/admin/help-center-category/update/" + id,
              status: 'OK',
              fieldErrors: {},
              customFieldErrors: {},
              module: 'Help Center',
     ...
     Promise.all([
        HelpCenterCategory.findOne({id: id}),
        ...
        if (Object.keys(customFieldErrors).length) {
          req.flash('errorMessage', 'Error in Update');
            ...
            //  ==================Start=====================
              return HelpCenterCategory.update({id: id}, _formData).then(function (_updateSingle) {
     ...
     // ==================Save End=======================
      ...
      view: function (req, res) {
        ...
        HelpCenterCategory.findOne({id:id}).then(function (singleData){
          if (!singleData) {
            ...
            return res.view("admin/help-center-category/view", {
                flashMsgError: req.flash('flashMsgError'),
                flashMsgSuccess: req.flash('flashMsgSuccess'),
                data: singleData,
                moment: moment,
      ...
      delete : function (req, res) {
        ...
        Promise.all([
            HelpCenterCategory.findOne({id: id}),
            HelpCenter.findOne({helpCenterCategory:id},{select: ['id']}),
        ]).spread(function(deleteData, hasData){
          if(!deleteData){
            req.flash('flashMsgError', 'Data Not found In Database');
            return res.redirect('/admin/help-center-category/index');
          }
