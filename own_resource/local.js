...
module.exports = {
  ...
  // ssl: {
  //   // ca: require('fs').readFileSync(__dirname + '/ssl/ssl_gd_bundle.crt', 'utf8').toString(),
  //   key: require('fs').readFileSync(__dirname + '/ssl/localhost.key', 'utf8').toString(),
  //   cert: require('fs').readFileSync(__dirname + '/ssl/localhost.crt', 'utf8').toString()
  // },
